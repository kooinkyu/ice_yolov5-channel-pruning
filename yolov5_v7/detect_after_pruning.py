...
def run(
        weights="/home/jovyan/lost+found/ice_sleep_detpj/yolov5_v7/runs/train/ice_eye_mouth20_softBN_finetune_1e-3_fixed/weights/best.pt",  # model path or triton URL
        source="/home/jovyan/lost+found/ice_sleep_detpj/yolov5_v7/data/images/bus.jpg",  # file/dir/URL/glob/screen/0(webcam)
        data="/home/jovyan/lost+found/ice_sleep_detpj/data/ice_driver_ct.yaml",  # dataset.yaml path
...
if __name__ == "__main__":
    ...
    # ==============================
    pruned_model = run(
        weights="/home/jovyan/lost+found/ice_sleep_detpj/yolov5_v7/runs/train/ice_eye_mouth20_softBN_finetune_1e-3_fixed/weights/best.pt",
        source="/home/jovyan/lost+found/ice_sleep_detpj/yolov5_v7/data/images/bus.jpg",
    ...
    torch.save(
        {
            ...
            'yaml': getattr(pruned_model.model if hasattr(pruned_model, 'model') else pruned_model, 'yaml', None)
        },
        save_path
    )
